...
interface PageProps {
  params: {
    slug: string[]; // This will match the expected structure
  };
}

export default function ShopPage({ params }: PageProps) {
  // Use 'params' directly without destructuring slug
  // You can access 'slug' using params.slug
  console.log(params.slug); // For debugging or using the 'slug' in logic
